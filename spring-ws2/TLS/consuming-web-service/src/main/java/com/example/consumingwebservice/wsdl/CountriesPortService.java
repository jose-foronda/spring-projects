 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://spring.io/guides/gs-producing-web-service", wsdlLocation = "https://localhost:8081/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://localhost:8081/ws/countries.wsdl");
